...
const DOM = {
    ...
    BackgroundPhoto(n, m){
        ...
        let code = `<img class="background-image first front" src="./background images/${BackgroundImg[n]}.jpg" alt="Background Image">
                    <img class="background-image second" src="./background images/${BackgroundImg[m]}.jpg" alt="Background Image">`;
